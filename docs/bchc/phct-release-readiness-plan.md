...
This is BCHC's protected snapshot of the canonical PHCT plan. Reusable plan updates are authored
in PHCT; BCHC keeps this copy with its deployment-owned operational records.
...
The canonical execution record is `phct/docs/release-readiness-plan.md`. This downstream snapshot
exists for BCHC handoff context; changes to release scope, gates, or shared-code policy are made in
PHCT first and reach this repository through a versioned parent release.
